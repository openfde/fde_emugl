...
##
LIBRENDER_DIR=android-emugl/host/libs/libOpenglRender
LIBRENDER_INCLUDE=android-emugl/host/include/OpenglRender
gen_funcargs_header \
...
##
OPENGLES_DISPATCH_SRCDIR=android-emugl/host/libs/libOpenGLESDispatch
OPENGLES_DISPATCH_INCLUDE=android-emugl/host/include/OpenGLESDispatch
