// Auto-generated with: scripts/gen-entries.py --mode=functions android-emugl/host/libs/libOpenGLESDispatch/render_egl_extensions.entries --output=android-emugl/host/include/OpenGLESDispatch/RenderEGL_extensions_functions.h
