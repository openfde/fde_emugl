// Auto-generated with: scripts/gen-entries.py --mode=funcargs android-emugl/host/libs/libOpenGLESDispatch/gles2_only.entries --output=android-emugl/host/include/OpenGLESDispatch/gles2_only_functions.h
