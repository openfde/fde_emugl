// Auto-generated with: scripts/gen-entries.py --mode=funcargs android-emugl/host/libs/libOpenGLESDispatch/gles3_only.entries --output=android-emugl/host/include/OpenGLESDispatch/gles3_only_functions.h
