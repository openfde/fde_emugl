// Auto-generated with: scripts/gen-entries.py --mode=funcargs android-emugl/host/libs/libOpenGLESDispatch/gles1_extensions.entries --output=android-emugl/host/include/OpenGLESDispatch/gles1_extensions_functions.h
