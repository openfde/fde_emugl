// Auto-generated with: scripts/gen-entries.py --mode=functions android-emugl/host/libs/libOpenGLESDispatch/render_egl.entries --output=android-emugl/host/include/OpenGLESDispatch/RenderEGL_functions.h
