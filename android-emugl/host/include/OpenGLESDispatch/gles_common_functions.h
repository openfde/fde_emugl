// Auto-generated with: scripts/gen-entries.py --mode=funcargs android-emugl/host/libs/libOpenGLESDispatch/gles_common.entries --output=android-emugl/host/include/OpenGLESDispatch/gles_common_functions.h
