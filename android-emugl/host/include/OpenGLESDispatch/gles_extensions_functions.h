// Auto-generated with: scripts/gen-entries.py --mode=funcargs android-emugl/host/libs/libOpenGLESDispatch/gles_extensions.entries --output=android-emugl/host/include/OpenGLESDispatch/gles_extensions_functions.h
