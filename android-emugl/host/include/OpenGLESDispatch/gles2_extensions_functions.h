// Auto-generated with: scripts/gen-entries.py --mode=funcargs android-emugl/host/libs/libOpenGLESDispatch/gles2_extensions.entries --output=android-emugl/host/include/OpenGLESDispatch/gles2_extensions_functions.h
