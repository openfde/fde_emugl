// Auto-generated with: scripts/gen-entries.py --mode=funcargs android-emugl/host/libs/libOpenGLESDispatch/gles1_only.entries --output=android-emugl/host/include/OpenGLESDispatch/gles1_only_functions.h
