...
public:
    ...
    virtual bool StartRenderServer(char* addr, size_t addrLen) = 0 ;
    ...
    virtual bool showOpenGLSubwindow(int wx,
                                     int wy,
                                     int ww,
                                     int wh,
                                     int fbw,
                                     ...
                                     float dpr,
                                     float zRot,
                                     bool deleteExisting, bool hideWindow) = 0;

    virtual bool updateWindowAttri(uint32_t display_id,
    ...
    virtual bool deleteWindowAttri(uint32_t display_id) = 0;
    ...
    virtual void setSupportDynamicSize(uint32_t display_id, unsigned int p_colorbuffer,
                                   int32_t width, int32_t height,bool support) = 0;
