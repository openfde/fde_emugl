...
AEMU_EXPORT int android_showOpenglesWindow(int wx,
                                           int wy,
                                           int ww,
                                           int wh,
                                           int fbw,
...
AEMU_EXPORT int android_updateWindowAttri(uint32_t display_id,
...
AEMU_EXPORT int android_deleteWindowAttri(uint32_t display_id);
...
AEMU_EXPORT void android_setSupportDynamicSize(uint32_t display_id, unsigned int p_colorbuffer,
