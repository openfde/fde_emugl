...
struct renderControl_server_context_t {
    ...
    rcPostVirtualDisplay_server_proc_t rcPostVirtualDisplay;
    rcPostAllVirtualDisplaysDone_server_proc_t rcPostAllVirtualDisplaysDone;
    rcPostCaptureScreenColorBuffer_server_proc_t rcPostCaptureScreenColorBuffer;
