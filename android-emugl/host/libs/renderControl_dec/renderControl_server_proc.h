...
typedef void (renderControl_APIENTRY *rcPostVirtualDisplay_server_proc_t) (const char* name, uint32_t id, uint32_t bo_name, int32_t width, int32_t height, int32_t stride, int32_t bpp, int32_t orientation);
typedef void (renderControl_APIENTRY *rcPostAllVirtualDisplaysDone_server_proc_t)();
typedef void (renderControl_APIENTRY *rcPostCaptureScreenColorBuffer_server_proc_t)(uint32_t id);
