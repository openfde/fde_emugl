...
public:
    ...
    bool draw(GLuint texture, float rotationDegrees, float dx, float dy, 
        ...
        return drawImpl(texture, rotationDegrees, dx, dy, false, clipWidthRatio, clipHeightRatio);
    }
    ...
    bool drawWithOverlay(GLuint texture, float rotationDegrees, float dx, float dy, 
        float clipWidthRatio = 0, float clipHeightRatio = 0) {
        return drawImpl(texture, rotationDegrees, dx, dy, true, clipWidthRatio, clipHeightRatio);
    }
